...
unlocked to sign the Knotcoin-Qt.app bundle.
...
allowing somebody to distribute a Knotcoin-Qt.app or knotcoin-qt-setup.exe with a valid
...
that the knotcoin-qt.exe file inside the installer had not been tampered with.
