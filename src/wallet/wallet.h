...
#ifndef KNOTTCOIN_WALLET_WALLET_H
#define KNOTTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this knotcoin node, and set to 0 for transactions that were created
...
#endif // KNOTTCOIN_WALLET_WALLET_H
