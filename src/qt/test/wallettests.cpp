...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<KnotcoinAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_knotcoin-qt -platform xcb      # Linux
//     src/qt/test/test_knotcoin-qt -platform windows  # Windows
//     src/qt/test/test_knotcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = KnotcoinUnits::formatWithUnit(unit, balance, false, KnotcoinUnits::separatorAlways);
    ...
    // Amount input
    KnotcoinAmountField* amountInput = receiveCoinsDialog.findChild<KnotcoinAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: knotcoin:")) != -1);
