...
#ifndef KNOTTCOIN_TEST_SCRIPTNUM10_H
#define KNOTTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Knotcoin Core 0.10.0, for cross-comparison.
 */
public:
