...
#ifndef H_KNOTTCOIN_SCRIPT
#define H_KNOTTCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CKnotcoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Knotcoin always counted CHECKMULTISIGs
