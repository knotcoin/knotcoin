...
#if defined(NDEBUG)
# error "Knotcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Knotcoin Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KNOT additional fees, %d delta bytes\n",
...
{
    // After block 10.000.000 block reward stays at 1 Knot per block
