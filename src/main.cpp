...
uint256 hashGenesisBlock("0x00000000b0dfc261601656af92ad499da618fe05a4b5a9525a1e7ccf15bf5d0a");
...
const string strMessageMagic = "Knotcoin Signed Message:\n";
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uKNOT
                              ...
                              enum GetMinFee_mode mode) const
{
    ...
    if (fAllowFree)
    {
        if (nBlockSize == 1)
        {
            ...
            // (about 4500 KNOT if made of 50 KNOT inputs)
            if (nBytes < 10000)
                nMinFee = 0;
        }
        else
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 42000);

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 10 * 60; // ten minutes
...
void ThreadScriptCheck() {
    RenameThread("knotcoin-scriptch");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000001559f9143b0bd0b776b4afcd149d91d306d52a48e1856e204ae8e903");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=00000000b0dfc26, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=08ea1d, nTime=1519999999, nBits=0x1d00ffff, nNonce=441582848, vtx=1)
        //   CTransaction(hash=08ea1d, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        //     CTxIn(COutPoint(000000, -1), coinbase 04ffff001d01041732303138202d206b6e6f7474656420766f727469636573)
        //     CTxOut(nValue=100.00000000, scriptPubKey=410456b115b7ba1f40599a3f913af569070a05de56f381966e1dde5117327494e31bc528f321a4f6976b2d3de6cafef626fba510451149fcc875bce369d5590d5998ac)
        //   vMerkleTree: 08ea1dc363c2326a7d7303b98329e5749106c42e42c7c1acf92e4027fb8e08cf


        // Genesis block
        const char* pszTimestamp = "2018 - knotted vortices";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 100 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0456b115b7ba1f40599a3f913af569070a05de56f381966e1dde5117327494e31bc528f321a4f6976b2d3de6cafef626fba510451149fcc875bce369d5590d5998") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1519999999;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 441582848;

        if (fTestNet)
        {
            block.nTime    = 1520015200;
            block.nNonce   = 3266001242;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x08ea1dc363c2326a7d7303b98329e5749106c42e42c7c1acf92e4027fb8e08cf"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xb2, 0xdb, 0xdc, 0xac };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("KnotcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("KnotcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static KnotcoinMiner(CWallet *pwallet)
{
    printf("KnotcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("knotcoin-miner");
    ...
    try { loop {
        ...
        printf("Running KnotcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("KnotcoinMiner terminated\n");
        throw;
    }
}

void GenerateKnotcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&KnotcoinMiner, pwallet));
}
