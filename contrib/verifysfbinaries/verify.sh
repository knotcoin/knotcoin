...
WORKINGDIR="/tmp/knotcoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/knotcoin/Knotcoin/knotcoin-0.8.5/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/knotcoin/Knotcoin/"
VERSIONPREFIX="knotcoin-"
RCVERSIONSTRING="rc"
...
if [ $? -ne 0 ]; then
   ...
   echo "[knotcoin-]<version>-[rc[0-9]] (example: knotcoin-0.7.1-rc1)"
   echo "wget output:"
