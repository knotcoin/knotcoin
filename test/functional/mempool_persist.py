...
By default, knotcoind will dump mempool on shutdown and
...
class MempoolPersistTest(KnotcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(2)
        # Give knotcoind a second to reload the mempool
        ...
        self.log.debug("Prevent knotcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
