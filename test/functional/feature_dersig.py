...
class BIP66Test(KnotcoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # knotcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and knotcoind produces more specific reject
            # reasons.
