...
# TestNode: A peer we use to send messages to knotcoind, and store responses.
...
class CompactBlocksTest(KnotcoinTestFramework):
    ...
    # This test actually causes knotcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that knotcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for knotcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # knotcoind will not send blocktxn responses for blocks whose height is
