...
* knotcoin.conf: contains configuration settings for knotcoind or knotcoin-qt
* knotcoind.pid: stores the process id of knotcoind while running
...
* debug.log: contains debug information and general logging generated by knotcoind or knotcoin-qt
