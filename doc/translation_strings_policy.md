...
This document provides guidelines for internationalization of the Knotcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `knotcoin_en.ts` remains unchanged.
