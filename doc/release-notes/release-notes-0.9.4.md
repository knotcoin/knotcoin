Knotcoin Core version 0.9.4 is now available from:

  https://knotcoin.org/bin/0.9.4/
...
this update is incompatible with the Knotcoin system and could lead to consensus
forks.

Knotcoin Core released binaries from https://knotcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~knotcoin/+archive/ubuntu/knotcoin
- A third-party or self-compiled Knotcoin Core

upgrade to Knotcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
