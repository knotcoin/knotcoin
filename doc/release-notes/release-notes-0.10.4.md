Knotcoin Core version 0.10.4 is now available from:

  <https://knotcoin.org/bin/knotcoin-core-0.10.4/>
...
- #6953 `43c2789` Split knotcoin-tx into its own package
- #6953 `dfe0d4d` Include knotcoin-tx binary on Debian/Ubuntu
