Knotcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/knotcoin/files/Knotcoin/knotcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Knotcoin
...
New/changed settings (command-line or knotcoin.conf file)
--------------------------------------------------------
