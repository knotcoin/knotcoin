Download URL: https://sourceforge.net/projects/knotcoin/files/Knotcoin/knotcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 KNOT fee schedule (users still pay 0.01 KNOT per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #knotcoin00 - #knotcoin99
