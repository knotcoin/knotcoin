Knotcoin Core version 0.9.2.1 is now available from:

  https://knotcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 KNOT to 0.01 KNOT
...
- Fix "Start knotcoin on system login"
