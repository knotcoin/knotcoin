Knotcoin Core version 0.13.2 is now available from:

  <https://knotcoin.org/bin/knotcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update knotcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow knotcoin-tx to create v2 transactions (knotdrak)
