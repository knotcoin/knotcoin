Knotcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/knotcoin/files/Knotcoin/knotcoin-0.5.4/
...
http://gitorious.org/knotcoin/knotcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Knotcoin-Qt notifications under Growl 1.3.
Increase required age of Knotcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxKnotcoin properly when installing Knotcoin-Qt over it. (Windows)
